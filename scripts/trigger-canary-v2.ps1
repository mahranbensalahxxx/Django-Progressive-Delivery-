param(
    ...
    [string]$Image = "django-progressive:v2"
)

$ErrorActionPreference = "Stop"

Write-Host "============================================="
Write-Host "  Canary Trigger -> v2"
Write-Host "============================================="
...
Write-Host ""
Write-Host "[2/3] Updating rollout image to $Image ..."
...
if ($newImage -ne $Image) {
    Write-Error "Canary trigger failed. Expected '$Image' but got '$newImage'."
}

Write-Host ""
Write-Host "Canary update triggered successfully."
